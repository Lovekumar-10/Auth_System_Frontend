...
//           <Link
//             to="/"
//             className={`hover:text-gray-400 ${isActive("/") ? "underline" : ""}`}
//           >
//             Home
//           </Link>
//         </li>
...
//           <Link
//             to="/about"
//             className={`hover:text-gray-400 ${isActive("/about") ? "underline" : ""}`}
//           >
//             About
//           </Link>
//         </li>
...
//           <Link
//             to="/login"
//             className={`hover:text-gray-400 ${isActive("/login") ? "underline" : ""}`}
//           >
//             Login
//           </Link>
//         </li>
...
//           <Link
//             to="/register"
//             className={`hover:text-gray-400 ${isActive("/register") ? "underline" : ""}`}
//           >
//             Register
//           </Link>
//         </li>
    ...
    <header className="fixed w-full top-0 z-50 flex justify-center px-4 transition-all duration-500">
      <motion.nav
        ...
        animate={{
          ...
          opacity: 1,
          backgroundColor: isScrolled ? "var(--color-lighter-pink)" : "transparent",
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            className="p-3 rounded-full bg-white/50 text-[var(--color-dark-purple)] shadow-inner transition-all hover:bg-white cursor-pointer"
          >
